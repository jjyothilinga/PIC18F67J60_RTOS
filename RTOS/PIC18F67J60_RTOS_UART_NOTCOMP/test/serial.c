...
unsigned long ulBaud;
	...
	xRxedChars = xQueueCreate( 10/*uxQueueLength*/, ( unsigned portBASE_TYPE ) sizeof( char ) );
	xCharsForTx = xQueueCreate( 10/*uxQueueLength*/, ( unsigned portBASE_TYPE ) sizeof( char ) );
...
portBASE_TYPE xHigherPriorityTaskWoken = pdFALSE;
	...
	if( rxDataCount >= 10 )//uxQueueLength )
		rxDataCount = 0;
